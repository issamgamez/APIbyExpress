...
// connect to db
mongoose.connect('mongodb://localhost:27017/dbformation')
...
app.get('/formateurs/login',async(req,res)=>{
    try{
        ...
        // JWT
        const jwetoken = jwt.sign({email:formateur.email,name:formateur.name,password:formateur.password},'secretKey',{ expiresIn: '24h' })
